...
function toggleLoading(isLoading) {
  ...
  if (isLoading) {
    ...
    document.getElementById("submit").innerHTML = "<i class='fas fa-hourglass-half'>&nbsp;Loading…</i>";
  } else {
    document.getElementById("submit").removeAttribute("disabled");
    document.getElementById("submit").innerHTML = '<i class="fas fa-search"></i>&nbsp;Search';
  }
}
